    ...
    return (
        <nav className={styles.menu}>
            <div className={styles.nav} style={showMenu ? {display: "block"} : {}}>
                <NavLink className={cls(styles.menuLink, generateActive && styles.menuLinkActive)} to="/">Generate</NavLink>
                <NavLink className={cls(styles.menuLink, verifyActive && styles.menuLinkActive)} to="/verify">Verify</NavLink>
                <a className={cls(styles.menuLink, documentationActive && styles.documentationActive)} href="https://docs.decred.org/advanced/dcrtime/" target="_blank" rel="noopener noreferrer" aria-label="Dcrtime docs">Documentation</a>
            </div>
