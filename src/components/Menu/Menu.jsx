    ...
    return (
        <nav className={styles.menu}>
            <div className={styles.nav} style={showMenu ? {display: "block"} : {}}>
                ...
                <a className={cls(styles.menuLink, generateActive && styles.documentationActive)} href="https://docs.decred.org/advanced/dcrtime/" target="_blank" rel="noopener noreferrer" aria-label="Dcrtime docs">Documentation</a>
            </div>
